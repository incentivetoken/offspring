...
public class CancelSellOrderWizard extends GenericTransactionWizard {
  ...
  public CancelSellOrderWizard(final IUserService userService) {
    super(userService);
    setWindowTitle("Cancel Sell Order");
