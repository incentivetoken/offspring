    ...
    treeViewer.addSelectionChangedListener(new ISelectionChangedListener() {
      ...
      public void selectionChanged(SelectionChangedEvent event) {
        ...
        if (element instanceof MessageWrapper) {
          ...
          Long id = message.getSenderId().equals(accountId) ? message
              .getReceipientId() : message.getSenderId();
          String account = Convert.toUnsignedLong(id);
          ...
          Label status = new Label(recipientsComposite, SWT.NONE);
          if (message.getSenderId().equals(accountId)) {
            status.setText("[" + dateFormat.format(date) + "] Send to: ");
          }
          else {
            status.setText("[" + dateFormat.format(date) + "] Received from: ");
          }

          AccountLink link = new AccountLink(account, accountLinkListener);
