...
public class BuyOrderComparator extends ViewerComparator {
  ...
  public BuyOrderComparator() {
    this.columnID = BuyOrderTable.COLUMN_QUOTE_PRICE;
  ...
  public int compare(Viewer viewer, Object e1, Object e2) {
    IBuyOrder t1 = (IBuyOrder) e1;
    IBuyOrder t2 = (IBuyOrder) e2;
    Long v1, v2;
    int rc = 0;
    switch (columnID) {
