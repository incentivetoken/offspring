...
public class ShowTraderPerspectiveHandler {

  static Logger logger = Logger.getLogger(ShowTraderPerspectiveHandler.class);

  private final static String PART_ID = "com.dgex.offspring.application.perspective.trader";
