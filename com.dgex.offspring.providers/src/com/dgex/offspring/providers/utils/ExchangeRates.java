...
public class ExchangeRates {
  ...
  public static Double convertNqtToBtc(long value) {
    return (value / Constants.ONE_NXT) * getRate(DGEXCurrentRateProvider.getInstance(), Currencies.BTC, Currencies.NXT);
  }
  ...
  public static Double convertEurToBtc(double value) {
    return value / getRate(TickerAllProvider.getInstance(), Currencies.BTC, Currencies.EUR);
  }

  public static Double convertBtcToEur(double value) {
    return value * getRate(TickerAllProvider.getInstance(), Currencies.EUR, Currencies.BTC);
  }

  public static Double convertBtcToDollar(double value) {
    return value * getRate(TickerAllProvider.getInstance(), Currencies.USD, Currencies.BTC);
  }
